...
public class PhotoPicker {
    ...
    public static final int REQUEST_CODE = 233;//请求code
    public static final int REQUEST_EDITOR = 234;//请求code
    public static final int REQUEST_IMAGE = 235;//请求code
    public static final int RESULT_CANCEL = 236;//响应取消cancel
    public static final int IS_EDITOR = 237;//到达编辑页面
    ...
    public final static String EXTRA_MAX_COUNT = "MAX_COUNT";//最大选择数量
    public final static String EXTRA_SHOW_CAMERA = "SHOW_CAMERA";//是否显示camera
    public final static String EXTRA_SHOW_GIF = "SHOW_GIF";//是否显示gif
    public final static String EXTRA_GRID_COLUMN = "column";//GridView的列数，图片的展示列数
